...
<body>
    ...
    <div class="container">
        <div class="TambahProdi" style="color: black; font-size: 25px; font-family: Roboto; font-weight: 700; word-wrap: break-word; padding-top: 50px">
            Tambah Prodi</div>
    </div>

    <div class="container">
        <form method="POST" action="/tambah-prodi">
            @csrf
            <label for="prodi" style="color: black; font-size: 20px; font-family: Roboto; font-weight: 400; padding-top: 10px;">Prodi</label>
            <div class="form-row">
                <div class="form-group col-md-4">
                    <input type="text" class="form-control" id="prodi" name="prodi" placeholder="Masukkan Prodi" autocomplete="off">
                </div>
            </div>

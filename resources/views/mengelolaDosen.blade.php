...
<body>
    ...
    <div class="container">
        <div class="MengelolaDosen" style="color: black; font-size: 25px; font-family: Roboto; font-weight: 700; padding-top: 10px; margin-top: 20px;">
            Mengelola Dosen</div>
    </div>
    ...
    <div class="container" style="display: flex;">
        <div style="margin-right: 41.8%; display: flex;">
        ...
        <div style="margin-left: 41.8%; display: flex;">

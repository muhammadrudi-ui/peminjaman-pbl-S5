...
<body>
    ...
    <div class="container">
        <div class="MengelolaRuangan" style="color: black; font-size: 25px; font-family: Roboto; font-weight: 700; padding-top: 10px; margin-top: 20px;">
    ...
    <div class="container" style="display: flex;">
        <div style="margin-right: 41.2%; display: flex;">
        ...
        <div style="margin-left: 41.2%; display: flex;">

...
<body>
    ...
    <div class="container">
        <div class="TambahWaktu" style="color: black; font-size: 25px; font-family: Roboto; font-weight: 700; word-wrap: break-word; padding-top: 50px">
            Tambah Waktu</div>
    </div>

    <div class="container">
        <form method="POST" action="/tambah-waktu">
            @csrf
            <label for="waktu" style="color: black; font-size: 20px; font-family: Roboto; font-weight: 400; padding-top: 10px;">Waktu</label>
            <div class="form-row">
                <div class="form-group col-md-4">
                    <input type="text" class="form-control" id="waktu" name="waktu" placeholder="Masukkan Waktu" autocomplete="off">
                </div>
            </div>

...
<body>
    ...
    <div class="container">
        <div class="MengelolaWaktu" style="color: black; font-size: 25px; font-family: Roboto; font-weight: 700; padding-top: 10px; margin-top: 20px;">
            Mengelola Waktu</div>
    </div>
    ...
    <div class="container" style="display: flex;">
        <div style="margin-right: 41.3%; display: flex;">
        ...
        <div style="margin-left: 41.3%; display: flex;">
